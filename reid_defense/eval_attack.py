...
def main():
    ...
    weights_path = "/data3/yjb/experiment/adv_dist/reid_defense/logs/train/resnet18/reid_SmaraAD/norm_0.4_0.4_0.2/market1501/market1501-bagtricks_with_distiller_student_R18_fastreid-110.pth"
